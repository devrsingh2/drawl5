...
class UploadFilelHelper
{
    public static function uploadFile($request)
    {
        ...
        if ($check) {
            ...
            if ($extension !== 'pdf') {
                $output_image = self::convertImage(public_path('uploads/mc-types/').$image, public_path('uploads/mc-types/'.$randomName.'.jpg'), 100);
            } else {
