                                    ...
                                    <div class="basic-form">
                                        ...
                                        <form method="POST" action="{{ route('banner.update') }}" enctype='multipart/form-data'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="title" type="text" name="title" value="{{ old('title', $banner->title) }}" autofocus="autofocus" class="form-control ">
                                            </div>
                                            <div class="form-group">
                                                <label for="description">Description</label>
                                                <textarea id="description" type="text" name="description"  class="form-control ">{{ old('description', $banner->description) }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="image">Image</label>
                                                <input id="image" type="file" name="image" value="{{ old('image',$banner->image) }}"  autofocus="autofocus" class="form-control ">
                                                <img style="height:100px;width:100px" src="{{asset('public/img/banner/'.$banner->image)}}">
                                            </div>
