                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <form method="POST" action="{{ route('customer.store') }}" id="createCustomer">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="phone" type="text" name="phone" value="{{ old('phone') }}" autocomplete="phone" class="form-control ">
                                            </div>
                                            <div class="form-group row mb-0">
                                                <button type="submit" class="btn btn-primary btn-block" onclick="return onSubmit()">Register</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
