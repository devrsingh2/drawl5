                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="stat-widget-two">
                                    <div class="stat-content">
                                        <div class="stat-text">Today Requirements </div>
                                        <div class="stat-digit">{{count($requirement)}}</div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success w-5" role="progressbar" aria-valuenow="{{count($requirement)}}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-two">
                                    <div class="stat-content">
                                        <div class="stat-text">Today Bid's</div>
                                        <div class="stat-digit">{{count($bid)}}</div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary w-0" role="progressbar" aria-valuenow="{{count($bid)}}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-two">
                                    <div class="stat-content">
                                        <div class="stat-text">Today Purchase</div>
                                        <div class="stat-digit">{{count($purchase)}}</div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-warning w-0" role="progressbar" aria-valuenow="{{count($purchase)}}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-two">
                                    <div class="stat-content">
                                        <div class="stat-text">Today Completed</div>
                                        <div class="stat-digit"> {{count($requirement_completed)}}</div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger w-0" role="progressbar" aria-valuenow="{{count($requirement_completed)}}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                            <!-- /# card -->
