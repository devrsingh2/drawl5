                                            ...
                                            @if(isset($items))
                                                @foreach($items as $k => $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary" href="{{ route('vendor.edit', $item->id) }}"><i class="ti-eye"></i></a>
                                                            @if($item->role !== 1)
                                                                <a class="btn btn-danger" href="{{ route('vendor.delete', $item->id) }}" onclick="return confirm('Do you really want to delete this user?');"><i class="ti-trash"></i></a>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
