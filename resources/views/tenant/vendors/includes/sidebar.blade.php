<div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
    <div class="nano">
        <div class="nano-content">
            <div class="logo"><a href="{{ route('vendor.home') }}"><span>Reverse-Auction</span></a></div>
                ...
                <li @if(request()->segment(2) == 'dashboard' || request()->segment(2) == 'profile' || request()->segment(2) == 'setting') class="active open" @endif>
                    ...
                    <ul>
                        ...
                        <li @if(request()->segment(2) === 'setting') class="active" @endif >
                            <a href="{{ route('vendor.setting') }}">Settings</a>
                        </li>

                    </ul>
                </li>
                <li class="label">Resources</li>
                <li @if(request()->segment(2) == 'notification') class="active" @endif ><a href="{{ route('vendor.notification') }}"><i class="ti-file"></i> Notifications </a></li>
                ...
                || request()->segment(2) == 'completed-requirement'
                    ...
                    <ul>
                        <li @if(request()->segment(2) == 'active-bid-requirements') class="active" @endif >
                            <a href="{{ route('vendor.active-bid-requirement') }}">Active Bid Requirement</a>
                        </li>
                        <li @if(request()->segment(2) == 'inprogress-requirements') class="active" @endif >
                            <a href="{{ route('vendor.inprogress-requirement') }}">Inprogress Requirement</a>
                        </li>
                        <li @if(request()->segment(2) == 'completed-requirements') class="active" @endif >
                            <a href="{{ route('vendor.completed-requirement') }}">Completed Requirement</a>
                        </li>
                    </ul>
                </li>
