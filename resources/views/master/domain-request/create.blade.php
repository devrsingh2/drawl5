...
<div class="card">
    <div class="card-body">
        ...
        <form method="post" action="{{ route('admin.submit-request') }}">
            {{ csrf_field() }}
            @if ($errors->any())
            ...
            <div class="form-group">
                ...
                <input id="name" name="name" value="{{ old('name') }}" type="text" class="form-control"
                    placeholder='Xyz Inc.' required autofocus>
            </div>
            <div class="form-group">
                <label for="fqdn">Domain</label>
                <div class="input-group">
                    <input id="fqdn" name="fqdn" value="{{ old('fqdn') }}" type="text" class="form-control"
                        placeholder="xyz" aria-label="Comapny domain" aria-describedby="basic-addon2">
